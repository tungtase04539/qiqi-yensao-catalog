...
export const gifts = [
  {
    ...
    vi: {
      ...
      unitNote: 'Đơn giá lẻ 48.000₫/hũ',
      sets: [
        { name: 'Set 6', sub: '6 hũ × 70ml', price: '288.000 ₫' },
        { name: 'Set 8', sub: '8 hũ × 70ml', price: '384.000 ₫' },
        { name: 'Set 10', sub: '10 hũ × 70ml', price: '480.000 ₫', featured: true },
      ],
    },
    cn: {
      ...
      unitNote: '零售单价 48.000₫/瓶',
      sets: [
        { name: '6 瓶装', sub: '6 瓶 × 70ml', price: '288.000 ₫' },
        { name: '8 瓶装', sub: '8 瓶 × 70ml', price: '384.000 ₫' },
        { name: '10 瓶装', sub: '10 瓶 × 70ml', price: '480.000 ₫', featured: true },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    vi: {
      ...
      unitNote: 'Đơn giá lẻ 55.000₫/hũ',
      sets: [
        { name: 'Set 6', sub: '6 hũ × 70ml', price: '330.000 ₫' },
        { name: 'Set 8', sub: '8 hũ × 70ml', price: '440.000 ₫' },
        { name: 'Set 10', sub: '10 hũ × 70ml', price: '550.000 ₫', featured: true },
      ],
    },
    cn: {
      ...
      unitNote: '零售单价 55.000₫/瓶',
      sets: [
        { name: '6 瓶装', sub: '6 瓶 × 70ml', price: '330.000 ₫' },
        { name: '8 瓶装', sub: '8 瓶 × 70ml', price: '440.000 ₫' },
        { name: '10 瓶装', sub: '10 瓶 × 70ml', price: '550.000 ₫', featured: true },
      ],
    },
  },
  {
    ...
    vi: {
      ...
      unitNote: 'Đơn giá lẻ 55.000₫/hũ',
      sets: [
        { name: 'Set 6', sub: '6 hũ × 75ml', price: '330.000 ₫' },
        { name: 'Set 8', sub: '8 hũ × 75ml', price: '440.000 ₫' },
        { name: 'Set 10', sub: '10 hũ × 75ml', price: '550.000 ₫', featured: true },
      ],
    },
    cn: {
      ...
      unitNote: '零售单价 55.000₫/瓶',
      sets: [
        { name: '6 瓶装', sub: '6 瓶 × 75ml', price: '330.000 ₫' },
        { name: '8 瓶装', sub: '8 瓶 × 75ml', price: '440.000 ₫' },
        { name: '10 瓶装', sub: '10 瓶 × 75ml', price: '550.000 ₫', featured: true },
      ],
    },
  },
  {
    ...
    vi: {
      ...
      sets: [
        { name: 'Set 6', sub: '6 hũ × 150ml', price: '720.000 ₫' },
        { name: 'Set 8', sub: '8 hũ × 150ml', price: '960.000 ₫' },
        { name: 'Set 10', sub: '10 hũ × 150ml', price: '1.200.000 ₫', featured: true },
      ],
    },
    cn: {
