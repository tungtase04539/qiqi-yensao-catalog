...
export const products = [
  ...
  },
  {
    ...
    vi: {
      ...
      specLabel: 'QUY CÁCH', spec: 'Lọ thủy tinh 75ml',
    ...
    cn: {
      ...
      specLabel: '规格', spec: '玻璃瓶 75ml',
      priceLabel: '价格', price: '10 元', priceUnit: '/瓶',
    },
  },
  {
    id: 'duong-kieng',
    ...
    vi: {
      ...
      specLabel: 'QUY CÁCH', spec: 'Lọ thủy tinh 70ml',
    ...
    cn: {
      ...
      specLabel: '规格', spec: '玻璃瓶 70ml',
      priceLabel: '价格', price: '12 元', priceUnit: '/瓶',
    },
  },
  {
    id: 'duong-phen',
  ...
  },
  {
    ...
    vi: {
      ...
      specLabel: 'QUY CÁCH', spec: 'Lọ thủy tinh 150ml',
    ...
    cn: {
      ...
      specLabel: '规格', spec: '玻璃瓶 150ml',
      priceLabel: '价格', price: '26 元', priceUnit: '/瓶',
    },
  },
  {
    id: 'duong-phen-150',
    ...
    cn: {
      ...
      specLabel: '规格', spec: '玻璃瓶 150ml',
      priceLabel: '价格', price: '22 元', priceUnit: '/瓶',
    },
  },
  {
    id: 'yen-sam-dk-150',
...
export const gifts = [
  {
    ...
    cn: {
      ...
      unitNote: '零售单价 12 元/瓶',
      sets: [
        { name: '6 瓶装', sub: '6 瓶 × 70ml', price: '85 元' },
        { name: '10 瓶装', sub: '10 瓶 × 70ml', price: '160 元', featured: true },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    cn: {
      ...
      unitNote: '零售单价 10 元/瓶',
      sets: [
        { name: '6 瓶装', sub: '6 瓶 × 75ml', price: '85 元' },
        { name: '10 瓶装', sub: '10 瓶 × 75ml', price: '160 元', featured: true },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    cn: {
      ...
      unitNote: '零售单价 22 元/瓶',
      sets: [
        { name: '6 瓶装', sub: '6 瓶 × 150ml', price: '160 元' },
        { name: '8 瓶装', sub: '8 瓶 × 150ml', price: '190 元', featured: true },
      ],
    },
  },
  {
    ...
    cn: {
      ...
      unitNote: '零售单价 26 元/瓶',
      sets: [
        { name: '6 瓶装', sub: '6 瓶 × 150ml', price: '178 元' },
        { name: '8 瓶装', sub: '8 瓶 × 150ml', price: '230 元', featured: true },
      ],
    },
  },
];
